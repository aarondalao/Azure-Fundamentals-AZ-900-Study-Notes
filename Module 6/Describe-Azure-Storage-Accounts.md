The following [video](https://www.microsoft.com/en-us/videoplayer/embed/RE4MAbS?postJsllMsg=true) introduces the different services that should be available with Azure Storage.
